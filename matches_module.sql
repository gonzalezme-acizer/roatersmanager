...
-- 2. Alter EVENTS table to support matches
...
-- Storage Policy for Club Logos (if they upload them)
-- Assuming we reuse the existing avatars bucket or create a new 'clubs' bucket. Let's create 'clubs' bucket.
